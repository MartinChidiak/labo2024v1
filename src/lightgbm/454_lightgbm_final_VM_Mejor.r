...
PARAM$finalmodel$num_iterations <- 397
PARAM$finalmodel$learning_rate <- 0.03329545969
PARAM$finalmodel$feature_fraction <- 0.512440857
PARAM$finalmodel$min_data_in_leaf <- 1354
PARAM$finalmodel$num_leaves <- 363
