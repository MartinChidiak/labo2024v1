...
setwd("C:/Users/Martin/OneDrive/Maestría/8-LaboratoriodeImplementacion1/Clase 2/") # Establezco el Working Directory
# cargo los datos
...
for (vmax_depth in c( 10, 12, 14)) {
  for (vmin_split in c(160, 320, 640)) {
    for (vcp in c(-0.5,-0.3,-0,1)) {
      for (vminbucket in c(4, 8, 12)) {
