...
filename <- paste("./plots/MS_", PARAM$minsplit, "_MB_", PARAM$minbucket, "_MD_", PARAM$maxdepth,"_TRG_", dataset[fold==1, max(ganancia_acumulada)],"_TEG_", dataset[fold==2, max(ganancia_acumulada)], ".png", sep = "")
ggsave(filename, gra, width = 10, height=10, dpi=300, units = "in")
