...
setwd("C:/Users/Martin/OneDrive/Maestría/8-LaboratoriodeImplementacion1/Clase 3/") # Establezco el Working Directory
# cargo los datos
...
archivo_salida <- "./exp/HT2020/gridsearchClase3Laptopv1.txt"
